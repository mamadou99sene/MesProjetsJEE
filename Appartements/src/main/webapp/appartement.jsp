...
<jsp:useBean id="appartement" class="momo.model.Appartement" scope="page">
</jsp:useBean>  
<jsp:setProperty property="*" name="appartement"/>
<!DOCTYPE html>
<html>
<head>
...
<body>
   <div class="container">
    ...
    <form method="post" id="form" action="appartement" class="form-responsive" >
   	<div class="col-sm-6">
  		<label for="libelle" class="form-label">Libelle</label>
  			<input type="text" name="libelle" required="required" id="libelle" class="form-control">
  	</div>
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
    	...
    	<input type="number" name="prix" required="required" id="prix" class="form-control">
    </div>
    <div class="col-md-6">
    	<label for="description">Description</label>
    	<textarea name="description" cols="40" rows="10" placeholder="description" class="form-control"></textarea>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" name="ville" class="form-control">
   	...
   	<!--  div class="mb-3">
   		...
   		<input type="file" name="photo[]" multiple="multiple" size="500000000000" accept="image/*" class="form-control-md">
   	</div> -->
   	<div class="col-sm-8">
